...
![image-20210524223718824](JVM.assets/image-20210524223718824.png)
...
==-XX:ParallelGCThreads==：在CPU非常多的环境中，可以限制垃圾收集的线程数。

![image-20210524224653874](JVM.assets/image-20210524224653874.png)
...
> 目标是达到一个可控制的吞吐量。还有一个值得关注的点是：GC自适应调节策略（与ParNew收集器最重要的一个区别）
...
![image-20210524225009735](JVM.assets/image-20210524225009735.png)
...
![image-20220604165820674](JVM.assets/image-20220604165820674.png)
